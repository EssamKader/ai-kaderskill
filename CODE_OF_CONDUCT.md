...
project maintainer via a private GitHub issue or the contact method listed on the
maintainer's GitHub profile. All complaints will be reviewed and investigated promptly and
fairly.

<!-- Maintainer: add a dedicated contact email here if you'd rather not rely on GitHub's
     private-issue/profile-contact route - deliberately left out of this file by default so
     a personal address isn't published without an explicit decision to do so. -->
